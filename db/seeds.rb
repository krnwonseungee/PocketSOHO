...
Business.create(name: "Sample Biz", image_url: "http://wiki.tripwireinteractive.com/images/4/47/Placeholder.png", city: "San Francisco", state: "CA", description: "Lorem ipsum dolor sit amet, odio ignota cetero id vim, mea modo vide fabulas ad. His id animal aliquando, et cibo utamur vim. Id etiam dissentias sed, has prompta delicatissimi cu. Id mei probo novum harum, per falli utinam labores ut. Ei sed reque harum." )

#BusinessOwner
BusinessOwner.create(first_name: "Janet", last_name: "Yi", email: "janet@sample.com", city: "Union City", state: "CA", phone: "555-555-1234", image_url: "http://www.imcslc.ca/imc/includes/themes/imc/images/layout/img_placeholder_avatar.jpg", password: "password", password_confirmation: "password", type: "BusinessOwner" )
#Customer
Customer.create(first_name: "Alex", last_name: "Simpson", email: "alex@sample.com", city: "Silver Spring", state: "MD", phone: "555-555-1235", image_url: "http://www.imcslc.ca/imc/includes/themes/imc/images/layout/img_placeholder_avatar.jpg", password: "password", password_confirmation: "password", type: "Customer" )
Customer.create(first_name: "Twin", last_name: "Young", email: "jinahill89@gmail.com", city: "Oakland", state: "CA", phone: "555-555-1236", image_url: "http://www.imcslc.ca/imc/includes/themes/imc/images/layout/img_placeholder_avatar.jpg", password: "password", password_confirmation: "password", type: "Customer" )
Customer.create(first_name: "Bob", last_name: "Smith", email: "bob@sample.com", city: "San Francisco", state: "CA", image_url: "http://www.imcslc.ca/imc/includes/themes/imc/images/layout/img_placeholder_avatar.jpg", password: "password", password_confirmation: "password", type: "Customer" )
Customer.create(first_name: "Tae", last_name: "Yi", email: "tae@sample.com", city: "San Francisco", state: "CA", image_url: "http://www.imcslc.ca/imc/includes/themes/imc/images/layout/img_placeholder_avatar.jpg", password: "password", password_confirmation: "password", type: "Customer" )
Customer.create(first_name: "Hong", last_name: "Yi", email: "hong@sample.com", city: "San Francisco", state: "CA", image_url: "http://www.imcslc.ca/imc/includes/themes/imc/images/layout/img_placeholder_avatar.jpg", password: "password", password_confirmation: "password", type: "Customer" )

#building associations
Business.first.users = User.all
