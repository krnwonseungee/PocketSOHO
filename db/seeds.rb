...
Business.create(name: "2nd Sample Bizz", business_owner_id: 1 )
Customer.create(first_name: "Tae", email: "tae@sample.com", business_id: 2 )
Customer.create(first_name: "Dad", email: "Dad@sample.com", business_id: 2 )
